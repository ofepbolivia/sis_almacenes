    ...
    Phx.vista.Almacen = Ext.extend(Phx.gridInterfaz, {
        constructor : function(config) {
            ...
            this.addButton('btnStock', {
                ...
                tooltip : '<b>Predefine stock mínimo para todos los ítems por almacén seleccionado</b>'
            });
        },
        ...
        onBtnSwitchEstado : function() {
            ...
            Ext.Msg.confirm('Confirmación', '¿Está seguro de activar/inactivar este almacén?', function(btn) {
                if (btn == "yes") {
                    Ext.Ajax.request({
                        url : '../../sis_almacenes/control/Item/switchEstadoAlmacen',
                        params : {
        ...
        tabsouth:[{
            ...
            title : 'Stock Mínimo de almacenes',
            height: '50%',
            cls : 'AlmacenStock'
        }
