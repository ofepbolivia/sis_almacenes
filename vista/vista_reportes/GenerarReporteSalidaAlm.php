...
/**
 *@package pXP
 *@file    GenerarReporteSalidaAlm.php
...
?>
<script>
	Phx.vista.GenerarReporteSalidaAlm = Ext.extend(Phx.frmInterfaz, {
		Atributos : [
		    {
			config : {
				name : 'id_almacen',
		...
		title : 'Generar Reporte Salida Almacén',
		ActSave : '../../sis_almacenes/control/Reportes/reporteSalidaAlmacen',
		topBar : true,
		botones : false,
		labelSubmit : 'Imprimir',
		tooltipSubmit : '<b>Reporte Salida Almacen</b>',
        timeout: 1000000,
		constructor : function(config) {
			Phx.vista.GenerarReporteSalidaAlm.superclass.constructor.call(this, config);
			this.init();
