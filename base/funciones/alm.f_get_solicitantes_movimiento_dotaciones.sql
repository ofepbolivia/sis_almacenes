...
BEGIN
	...
	v_i=0;
	FOR v_funcionario IN (select emp.desc_funcionario1, coalesce(fun.lugar_nombre,'') as lugar_nombre, coalesce(fun.oficina_nombre,'') as oficina_nombre, alm.f_get_items_movimiento(mov.id_movimiento) as item
