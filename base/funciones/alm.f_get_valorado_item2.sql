...
BEGIN
    ...
    ELSEIF (p_valoracion = 'PEPS') THEN --RAISE EXCEPTION 'p_id_item: %, %',p_id_item, p_id_almacen;
      --obtener el aux_saldo mas antiguo distinto de cero
        ...
        --raise exception 'valores: %, %, %',v_saldo_fisico, r_costo_valorado, r_id_movimiento_det_val_desc;
